...
import lilacPotion from "../assets/lilacPotion.gif";
    ...
    <>
      <div className="menu">
        ...
        <div className="websites">
          ...
          <a href="https://selinasshop.netlify.app/">
            <img src={lilacPotion} alt="Lilac potion to Selina's Website" id="lilac_potion" />
          </a>
